...
const toLastNames = people => {
  // Solution code here...
  let tempArray = people.map( item => `${item.firstName} ${item.lastName}`);
  return tempArray;
};
...
const addValues = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => acc += element, 0);
  return tempArray;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => acc += element.purchasePrice, 0);
  return tempArray;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce(acc => acc += 1, 0);
  return tempArray;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => {
...
const reversedString = (str) => {
  // Solution code here...
  let tempArray = str.split('').reduce((acc, element) => element + acc, '');
  return tempArray;
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => element.children ? acc += element.children.length : acc, 0);
  return tempArray;
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element, index) => index === arr.length-1 ? (acc+element)/(index+1) : acc += element, 0);
  return tempArray;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => isPrime(element) ? acc += 1 : acc, 0);
  return tempArray;
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  let tempArray = arr.reduce((acc, element) => {
    element.stat.name === statName ? acc = element : null;
    return acc;
  }, '');
  return tempArray;
};
...
const extractChildren = (arr) => {
  // Solution code here...
  let filterArray = arr.filter(item => item.children ? true : false);
  let filterBy = filterArray.filter(item => item.name.includes('a') ? true : false);
  let tempArray = filterBy.reduce((acc, element) => {
    element.children.map(item => acc.push(item))
    return acc;
  }, [])
  return tempArray;
};
