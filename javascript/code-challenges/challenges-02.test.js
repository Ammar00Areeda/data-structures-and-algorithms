...
const raisedToTheThird = (arr) => {
  let tempArray =[];
  arr.forEach(element => tempArray.push(Math.pow(element, 3)));
  return tempArray;
};
...
const addOne = (arr) => {
  let tempArray = arr.map(item => item + 1);
  return tempArray;
};
...
const forLoopTwoToThe = (arr) => {
  let tempArray = [];
  for (let i = 0; i < arr.length; i++) {tempArray.push(Math.pow(2, arr[i]));}
  return tempArray;
};
...
const forEachTwoToThe = (arr) => {
  let tempArray = [];
  arr.forEach(element => tempArray.push(Math.pow(2, element)))
  return tempArray;
};
...
const mapTwoToThe = (arr) => {
  let tempArray = arr.map(item => Math.pow(2, item));
  return tempArray;
};
